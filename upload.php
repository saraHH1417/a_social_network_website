...
if(isset($_FILES['image']['name'])){
    ...
    $_SERVER['DOCUMENT_ROOT'] = explode("/" , $_SERVER['DOCUMENT_ROOT']);
    $_SERVER['DOCUMENT_ROOT'] = $_SERVER['DOCUMENT_ROOT'][0] . "\\"  . $_SERVER['DOCUMENT_ROOT'][1] . "\\" . $_SERVER['DOCUMENT_ROOT'][2];
    $uploaddir = $_SERVER['DOCUMENT_ROOT'].'\\projects\\web\\1_Udemy_Build_Social_Network_from_Scratch_JavaScript_PHP\\demo\\assets\\images\\profile_pics';
    //Set File name
